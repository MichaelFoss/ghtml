...
- toolbar integration (only if a reliable Gmail extension point is
  found)
...
- settings page
- import/export
- richer HTML editing experience

Each feature should be developed on a feature branch as a series of
